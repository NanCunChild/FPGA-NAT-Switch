...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl/verilog" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl/verilog" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_nat xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_nat -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nancunchild/class_related/Graduation_Design/project_NAT/project_NAT.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_nat_sc.so .tmp_log xcelium_lib waves.shm c.obj)
