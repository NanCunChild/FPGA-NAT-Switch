...
#
# Script generated by Vivado on Tue Apr 28 02:00:37 CST 2026
...
#
# Usage        : vio_nat.sh
#                vio_nat.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                vio_nat.sh [-rerun]
#                vio_nat.sh [-reset_run]
#                vio_nat.sh [-clean]
#                vio_nat.sh [-reset_log]
#                vio_nat.sh [-help]
#
...
#                script (type 'vio_nat.sh -help' for more information).
#
...
# script info
echo -e "vio_nat.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./vio_nat.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl/verilog" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl/verilog" +incdir+"../../../../project_NAT.gen/sources_1/ip/vio_nat/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.vio_nat xil_defaultlib.glbl -o vio_nat_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./vio_nat_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/nancunchild/class_related/Graduation_Design/project_NAT/project_NAT.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key vio_nat_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_nat_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./vio_nat.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: vio_nat.sh [-help]\n\
Usage: vio_nat.sh [-step]\n\
Usage: vio_nat.sh [-lib_map_path]\n\
Usage: vio_nat.sh [-rerun]\n\
Usage: vio_nat.sh [-reset_run]\n\
Usage: vio_nat.sh [-clean]\n\
Usage: vio_nat.sh [-reset_log]\n\
Usage: vio_nat.sh [-keep_index]\n\
Usage: vio_nat.sh [-noclean_files]\n\n\
