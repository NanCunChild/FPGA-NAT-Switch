...
#
# Script generated by Vivado on Wed Apr 22 12:45:25 CST 2026
...
#                blk_mem_gen_4.sh [-rerun]
#                blk_mem_gen_4.sh [-reset_run]
#                blk_mem_gen_4.sh [-clean]
...
# script info
echo -e "blk_mem_gen_4.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_4 xil_defaultlib.blk_mem_gen_4 xil_defaultlib.glbl -log elaborate.log
}
...
Usage: blk_mem_gen_4.sh [-rerun]\n\
Usage: blk_mem_gen_4.sh [-reset_run]\n\
Usage: blk_mem_gen_4.sh [-clean]\n\
