...
#
# Script generated by Vivado on Sun Mar 08 14:30:08 +0800 2026
...
# script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_3 xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -log elaborate.log
}
