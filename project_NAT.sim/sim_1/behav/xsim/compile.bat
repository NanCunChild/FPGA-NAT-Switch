...
REM
REM Generated by Vivado on Sun Mar 08 19:12:01 +0800 2026
...
echo "xvlog --incr --relax -prj tb_NAT_Inbound_vlog.prj"
call xvlog  --incr --relax -prj tb_NAT_Inbound_vlog.prj -log xvlog.log
