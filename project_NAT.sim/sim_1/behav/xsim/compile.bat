...
REM
REM Generated by Vivado on Thu Dec 04 02:45:02 +0800 2025
...
echo "xvlog --incr --relax -prj tb_NAT_Mgr_vlog.prj"
call xvlog  --incr --relax -prj tb_NAT_Mgr_vlog.prj -log xvlog.log
